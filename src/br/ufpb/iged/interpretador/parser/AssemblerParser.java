// $ANTLR 3.4 C:\\Users\\Tiago\\Git\\IGED\\interpretador\\src\\br\\ufpb\\iged\\interpretador\\gramaticas\\Assembler.g 2012-09-05 23:51:34
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final AssemblerParser.definicaoClasse_return definicaoClasse() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: 30, membroClasse, superClasse, ID
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt12) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: operacao, parametros, INIT
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: ret, ID, operacao, parametros
                    // token labels: 
